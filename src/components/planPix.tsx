              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    futuramente, lançar cursos e mentorias exclusivas para quem
                    quer dominar a programação.
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">•</span>
                  <span>
                    Se você acredita no poder do conhecimento e quer apoiar esse
                    projeto, faça um Pix de qualquer valor!
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-2">•</span>
